...
## Instructions
This package assumes the use of **graph-based neural networks** and modifies 's `ExactGP` class in `gpytorch` to create a custom class **`ExactGP_graph`**, which allows **`pytorch_geometric`'s `Data`** to be used as input.  
